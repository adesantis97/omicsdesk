...
9. [Approfondimento: le tecniche del laboratorio Cirillo](#9-approfondimento-le-tecniche-del-laboratorio-cirillo)
10. [Se vince: primi 90 giorni e primi 12 mesi](#10-se-vince-primi-90-giorni-e-primi-12-mesi)
11. [Sopravvivenza pratica: pitfall, controlli, buone pratiche](#11-sopravvivenza-pratica-pitfall-controlli-buone-pratiche)
12. [Fonti](#12-fonti)
...
Il resto del documento è costruito per essere valido **indipendentemente** dal testo esatto del bando, perché il perimetro scientifico del laboratorio è definito e pubblico. Le sezioni che dovranno essere ritoccate a bando in mano sono contrassegnate con ⚙️.
...
**Fase 1 — Ginevra (lab Monica Gotta, Dept. of Cell Physiology and Metabolism, UNIGE; ambiente condiviso con Patrick Meraldi).**
...
**Fase 3 — Padova.** Affiliazione al **Dipartimento di Scienze Biomediche (DSB)**, complesso Vallisneri, viale G. Colombo 3. ⚙️ Il bando in oggetto è verosimilmente legato all'**avvio del suo gruppo indipendente**: questo cambia la natura della posizione — non si entra in una macchina rodata, si è tra i primi in laboratorio. È un rischio e insieme il maggiore argomento di vendita (vedi §7.5).
...
Uso di **FCS risolta nel tempo** per misurare l'associazione ciclina B1–Cdk1 lungo il ciclo. Il metodo-fondamenta del lavoro EMBO J.
...
|---|---|---|---|
| 2025 | **Santopietro MV**, Ferreri D, Prozzillo Y, Dimitri P, Messina G. *"The multitalented TIP60 chromatin remodeling complex: wearing many hats in epigenetic regulation, cell division and diseases"* — **Epigenetics & Chromatin** 18(1):40. DOI 10.1186/s13072-025-00603-8 | **primo autore** | Review: TIP60 fra regolazione epigenetica, riparo del DNA, sviluppo e divisione cellulare |
| 2023 | Prozzillo Y, **Santopietro MV**, Messina G, Dimitri P. *"Unconventional roles of chromatin remodelers and long non-coding RNAs in cell division"* — **Cell Mol Life Sci** 80(12):365 | co-autrice | Ruoli non canonici: subunità di SRCAP e p400/TIP60 su centrosomi/fuso/midbody in HeLa e U2OS; deplezione via RNAi → difetti di mitosi e citochinesi; lncRNA che rilocalizzano al midbody come **impalcatura architetturale** per l'abscissione |
| 2022 | Messina G, Prozzillo Y, **Santopietro MV**, Dimitri P. *"Evolutionary conserved relocation of chromatin remodeling complexes to the mitotic apparatus"* — **BMC Biology** | co-autrice | Il fenomeno è **conservato evolutivamente** — argomento forte contro l'obiezione "è un artefatto di linea cellulare" |
| 2021 | Messina G, Prozzillo Y, Delle Monache F, **Santopietro MV**, Atterrato MT, Dimitri P. *"The ATPase SRCAP is associated with the mitotic apparatus, uncovering novel molecular aspects of Floating-Harbor syndrome"* — **BMC Biology** 19(1):184 | co-autrice | SRCAP su centrosomi, fuso, midbody; interazione con regolatori della citochinesi; deplezione → difetti mitotici. Aggancio a **malattia rara umana** |
| 2020 | *"Targeted protein degradation tools: overview and future perspectives"* (gruppo Dimitri/Prozzillo) | co-autrice ⚙️ da verificare | Degron, dTAG/AID — **direttamente rilevante**: è la tecnologia di deplezione acuta usata nel campo di Cirillo |
...
**Probabili gap rispetto al lab Cirillo (⚙️ da confermare con lei — l'onestà qui è un vantaggio, non un rischio):**
...
Cirillo ha mostrato che la ciclina B1 lega il **nucleosoma** via arginine anchor. Domanda: quel legame è modulato dalle **modificazioni istoniche** o dalle varianti istoniche (H2A.Z — che è proprio il carico di SRCAP!)? Se SRCAP deposita H2A.Z e H2A.Z cambia l'affinità della piattaforma, si chiude un cerchio fra il suo dottorato e il nuovo lab.
**Esperimento minimo:** FCCS ciclina B1–APC/C in cellule deplete di SRCAP; *in vitro*, binding su nucleosomi ricostituiti con/senza H2A.Z.
**Questa è la proposta più forte: da preparare per prima.**
...
**Esperimento minimo:** FRAP/FCS di componenti al midbody; deplezione acuta via degron durante l'abscissione con imaging in tempo reale.
...
A cui si aggiungono **profondità di penetrazione** e **rapporto segnale/rumore**. Chi dice "voglio più risoluzione" senza dire a cosa rinuncia, non ha capito il problema. Il limite di diffrazione di Abbe fissa la risoluzione laterale a circa **λ/(2·NA)** ≈ **200–250 nm** in luce visibile con obiettivi ad alta apertura numerica; l'assiale è peggiore, ~500–700 nm.

### 8.2 Microscopie a campo largo e a scansione

| Tecnica | Principio | Risoluzione (laterale) | Punti di forza | Limiti |
|---|---|---|---|---|
| **Widefield** (epifluorescenza) | Illuminazione dell'intero campo, rivelazione su camera | ~200–250 nm | Veloce, sensibile, poca luce → ottimo per live imaging lungo | Luce fuori fuoco → contrasto scarso in campioni spessi |
| **Deconvoluzione** | Widefield + ricostruzione computazionale della PSF | ~150–200 nm effettivi | Recupera contrasto senza aumentare la dose | Richiede PSF accurata; artefatti se mal parametrizzata |
| **Confocale a scansione laser (LSCM)** | Pinhole che rigetta la luce fuori fuoco; scansione punto per punto | ~180–250 nm | Sezionamento ottico, z-stack puliti, standard per IF | Lento, alta dose locale, non ideale per live imaging veloce |
| **Confocale spinning disk** | Disco di Nipkow con migliaia di pinhole in parallelo | ~200–250 nm | **Sezionamento + velocità + bassa fototossicità** → il cavallo di battaglia del live imaging mitotico | Meno flessibile del LSCM, crosstalk fra pinhole in campioni spessi |
| **TIRF** | Onda evanescente, eccita solo ~100 nm sopra il vetrino | ~200 nm lat., ~100 nm assiale | Segnale/rumore straordinario, single-molecule | Solo la membrana basale: **inutile per la mitosi interna** |
...
⚙️ *Elenco dedotto dai metodi dei lavori pubblicati; da raffinare col testo del bando.*
...
- il **tempo di diffusione** → coefficiente di diffusione → massa/complessazione apparente
...
- **dTAG**: tag FKBP12^F36V + molecola bifunzionale che recluta la ligasi cereblon. Chimica alternativa, stesso principio.
...
- Mappare la BioImaging facility del dipartimento: quali sistemi, chi li gestisce, come si prenota, quanto costa. (Referenti scientifici della facility BioImaging in ambito UniPD: proff. Marta Giacomello e Luca Scorrano; responsabile di settore Federico Caicci. ⚙️ Verificare la struttura aggiornata al momento dell'ingresso.)
...
- Iniziare, in parallelo, la generazione della linea cellulare che servirà (knock-in o degron): sono i tempi lunghi, vanno lanciati per primi.
...
4. **Nessun controllo di specificità del fenotipo.** Un difetto mitotico dopo RNAi può essere off-target: serve un secondo siRNA indipendente e, idealmente, un rescue con costrutto resistente.
...
- [Where, When, and How? Integrating Spatiotemporal Cues in Cell Division — BioEssays 2026](https://onlinelibrary.wiley.com/doi/full/10.1002/bies.70093) · [versione PMC](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC12706138/)
- [Spatial control of the APC/C ensures the rapid degradation of cyclin B1 — EMBO J 2024](https://www.embopress.org/doi/abs/10.1038/s44318-024-00194-2) · [preprint bioRxiv](https://www.biorxiv.org/content/10.1101/2023.10.26.564157v1)
- [Bora, CEP192 and Cenexin… — Nature Communications 2026](https://www.nature.com/articles/s41467-026-75033-5) · [preprint bioRxiv](https://www.biorxiv.org/content/10.1101/2025.09.30.679461v1)
- [Cell cycle-dependent binding between Cyclin B1 and Cdk1 — Open Biology 2022](https://royalsocietypublishing.org/rsob/article/12/6/220057/91221/Cell-cycle-dependent-binding-between-Cyclin-B1-and)
- [Pagina alumni lab Gotta, UNIGE](https://www.unige.ch/medecine/phym/en/research/847gotta/alumni/luca-cirillo/) · [notizia corso Woods Hole](https://www.unige.ch/medecine/phym/phym-news/luca-cirillo-and-damian-dudka-chosen-for-a-prestigious-course-at-woods-hole)
- [Prof. Jonathon Pines — Institute of Cancer Research](https://www.icr.ac.uk/research-and-discoveries/find-a-researcher/detail/professor-jonathon-pines)
- [Seminario Sapienza, 29 novembre 2024](https://phd.uniroma1.it/web/luca-cirillo-institute-for-cancer-research-london-uk-mitotic-regulators-and-cell-division-29-november-2024_nA2514EN.aspx)

Pubblicazioni di M.V. Santopietro:
- [The multitalented TIP60 chromatin remodeling complex — Epigenetics & Chromatin 2025](https://link.springer.com/article/10.1186/s13072-025-00603-8) · [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC12220344/)
- [Unconventional roles of chromatin remodelers and lncRNAs in cell division — Cell Mol Life Sci 2023](https://link.springer.com/article/10.1007/s00018-023-04949-8) · [PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC10661750/)
- [Evolutionary conserved relocation of chromatin remodeling complexes to the mitotic apparatus — BMC Biology 2022](https://link.springer.com/article/10.1186/s12915-022-01365-5)
- [The ATPase SRCAP is associated with the mitotic apparatus — BMC Biology 2021](https://bmcbiol.biomedcentral.com/articles/10.1186/s12915-021-01109-x)
- [Scheda dottorato Sapienza](https://phd.uniroma1.it/web/MARIA-VIRGINIA-SANTOPIETRO_nP1632668_IT.aspx)

Contesto Padova:
- [Dipartimento di Scienze Biomediche — UniPD](https://www.biomed.unipd.it/) · [Albo bandi DSB](https://albo.biomed.unipd.it/web/bandi.php)
- [Facility BioImaging](https://www.biologia.unipd.it/dipartimento/organizzazione/settore-facility-bioimaging/) · [Light Microscopy Facility](https://www.biologia.unipd.it/servizi/servizi-alla-ricerca/imaging-facility/light-microscopy-facility/)

---

*Le sezioni contrassegnate ⚙️ vanno riviste una volta disponibili il testo del bando e il decreto di nomina della commissione.*
